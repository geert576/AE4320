...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       simNet() simulates the output of an single hidden layer
...
%   Original author E. de Weerdt, TUDelft, Faculty of Aerospace Engineering,
%ASTI & Control and Simulation Division
